...
window.SRK_CONFIG = {
  ...
  sessions: [
    ...
    },
    {
      ...
      /* 세션 콘텐츠 시드 — 카톡(2026.5.31~6.16)·노션 기반. s/dws-2026 가 비어 있을 때 1회만 심어짐 */
      seed: {
    ...
    },
    {
      ...
      accent: "red",
      title: "제6회 슈리키 랭킹전",
      subtitle: "클라이밍 랭킹전 · 더클라임 문래",
      location: "더클라임 문래점",
      summary: "순수 실력으로 최고 난이도를 겨루는 슈퍼리치키드 클라이밍 랭킹전.",
      detail: {
        intro: [
          "2시간 자유 등반으로 최고 난이도를 겨루는 슈퍼리치키드 랭킹전 6회차예요.",
          "※ 6/20 일정은 취소·환불됐고, MT 이후 날짜를 다시 공지할 예정입니다."
        ],
        sections: [
          { title: "타임테이블", icon: "calendar",
            rows: [["집합", "16:00"], ["시작", "16:30"], ["종료·단체사진", "18:30"], ["회식 이동", "19:00"]] },
          { title: "진행 방식", icon: "ballot",
            bullets: [
              "2시간 동안 자유롭게 돌아다니며 문제를 풉니다.",
              "개인 삼각대 필참 — 푼 문제는 반드시 영상으로 남겨야 결과 증빙이 돼요."
            ] },
          { title: "순위 산정", icon: "trophy",
            bullets: [
              "무조건 더 높은 난이도를 푼 사람이 위 (빨강 100개 < 보라 1개).",
              "동점이면 보라(8) → 7번 → 6번 → 5번 개수 순으로 비교."
            ] },
          { title: "주의사항", icon: "shield",
            bullets: [
              "문래점 사전 방문 금지.",
              "당일 오후 4시 이전 입장 금지 — 미리 들어가 푸는 것 안 돼요."
            ] },
          { title: "상품 · 회식", icon: "wallet",
            note: "상품은 크루 회비 일부로 클라이밍 유용템 구성 — 회식 후 랜덤으로 고르고, 고르는 순서만 등수로 정해요. 회식은 맛깔포차(문래).",
            foot: "선물은 다음 행사로 이월 보관 중." }
        ]
      }
    }
  ],
